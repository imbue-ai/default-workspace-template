...
The service only exists when the github-sync skill has enabled sync (it writes
the [program:github-sync] block to system/supervisord.conf.d/github-sync.conf).
"""
