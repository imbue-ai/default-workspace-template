...
For this project: the README's service documentation follows the new layout. The bootstrap itself is unchanged -- it still execs `supervisord -n -c system/supervisord.conf`, and supervisord resolves the include from there.
