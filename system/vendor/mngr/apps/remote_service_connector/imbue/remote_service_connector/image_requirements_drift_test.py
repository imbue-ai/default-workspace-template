...
# group entry of their own: pydantic and anyio are hard dependencies of
# fastapi (via starlette), and botocore of boto3.
_TRANSITIVELY_PROVIDED_ROOTS = frozenset({"pydantic", "anyio", "botocore"})
