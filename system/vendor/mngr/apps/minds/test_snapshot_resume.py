...
def _sign_in_with_api_key_via_modal(page: Page | Frame, api_key: str) -> None:
    ...
    Every selector is a ``data-e2e`` attribute rather than copy or a tailwind class: this drives
    the template's dialog from the other repo, so it has to survive a wording change or a
    re-port of the UI.
    """
