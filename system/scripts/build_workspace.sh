...
# Build every frontend of the npm workspace (deps installed by install_dependencies.sh;
# system/package.json lists the members), each into the static/ directory its backend serves.
