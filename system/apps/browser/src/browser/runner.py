...
Served at its own workspace origin (``browser.agent-<hex>.localhost`` locally,
``browser--<host>--<user>.<domain>`` on shares). Serves one
...
the viewer's relative URLs need no prefix awareness anywhere.
"""
