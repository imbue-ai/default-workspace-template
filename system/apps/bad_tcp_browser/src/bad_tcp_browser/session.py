"""One bad-tcp-browser session: a private Xvfb display + a full Chromium on it.
...
_FB_W = int(os.environ.get("BAD_TCP_BROWSER_FB_WIDTH", "1920"))
_FB_H = int(os.environ.get("BAD_TCP_BROWSER_FB_HEIGHT", "1080"))
...
_INIT_W = int(os.environ.get("BAD_TCP_BROWSER_WIDTH", "1280"))
_INIT_H = int(os.environ.get("BAD_TCP_BROWSER_HEIGHT", "800"))
_DISPLAY_BASE = 50
_DISPLAY_MAX = 79
_READY_TIMEOUT = 20.0
_PROFILE_DIR = Path("data/.apps/bad-tcp-browser/profile")
...
_START_URL = os.environ.get("BAD_TCP_BROWSER_START_URL", "https://duckduckgo.com")
