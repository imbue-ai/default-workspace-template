...
const BTN_VARIANTS: Record<ButtonVariant, string> = {
  ...
  secondary: "bg-surface text-primary border-default not-disabled:not-aria-disabled:hover:bg-fill-hover",
  ghost:
    "bg-transparent text-secondary border-transparent not-disabled:not-aria-disabled:hover:bg-fill-hover not-disabled:not-aria-disabled:hover:text-primary",
  destructive:
