/**
 * Confirmation dialog for a tab's irreversible-looking verb: destroying an
 * agent, a terminal or a browser, or unregistering an app.
 */
...
export const DestroyConfirmDialog: m.Component<DestroyConfirmDialogAttrs> = {
  view(vnode) {
    ...
    const confirmLabel = vnode.attrs.confirmLabel ?? "Destroy";
