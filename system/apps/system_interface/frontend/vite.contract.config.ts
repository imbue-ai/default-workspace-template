...
// serves at /_static/app_contract.js from its own origin (see SHELL_APP_CONTRACT_PATH in
// app_manifest.registry). Separate from the main build because a multi-entry app build shares
// chunks and would give the served file imports. Runs AFTER the main build, whose emptyOutDir
// would otherwise delete this output.
