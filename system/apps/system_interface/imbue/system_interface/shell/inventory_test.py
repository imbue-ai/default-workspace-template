...
def test_the_registry_read_lists_every_app_with_its_launch_paths(
    ...
    assert serialized[0]["launch_paths"] == [{"id": "new", "label": "New terminal", "path": "/new", "params": [], "text_param": None}]
    ...
    assert serialized[1]["launch_paths"] == [{"id": "open", "label": "Open Files", "path": "/", "params": [], "text_param": None}]
