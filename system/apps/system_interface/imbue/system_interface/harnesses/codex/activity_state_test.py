...
def test_turn_open_latches_on_the_latest_marker() -> None:
    ...
    assert turn_open([_turn_marker(SpecialEventKind.TURN_STARTED), _turn_marker(SpecialEventKind.TURN_COMPLETED)]) is False
    assert turn_open([_turn_marker(SpecialEventKind.TURN_STARTED), _turn_marker(SpecialEventKind.TURN_ABORTED)]) is False
