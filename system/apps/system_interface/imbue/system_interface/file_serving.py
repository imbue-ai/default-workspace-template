...
filesystem. Markdown like ``![chart](/home/user/workspace/data/chat-images/chart.png)``
(an inline image) or ``[report](/home/user/workspace/data/chat-files/report.pdf)`` (a
