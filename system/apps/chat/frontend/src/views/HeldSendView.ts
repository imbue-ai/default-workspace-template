 ...
 * message first, then anything sent since. Each renders as the faded not-yet-real user bubble the
 * optimistic outgoing overlay uses: the switch's own progress is the handoff node's to tell
