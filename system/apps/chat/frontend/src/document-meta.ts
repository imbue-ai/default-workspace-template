 ...
 * identity (and, on a subagent page, the agent and session it shows), the workspace's primary
 * agent, and the terminal app's origin label, so the page reads them off itself rather than
 * guessing them from the URL.
 */
