...
class SystemInterfaceState(MutableModel):
    ...
    chat_image_timestamps: ChatImageTimestampStore
    ...
    def shutdown(self) -> None:
        ...
        self.chat_image_timestamps.stop()
        try:
