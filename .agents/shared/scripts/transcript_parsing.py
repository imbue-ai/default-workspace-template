...
Used by the Stop-hook detector (``scripts/detect_crystallization_candidate.py``).
Kept dependency-free so it can be imported by a top-level hook script without
dragging in a virtualenv.
"""
