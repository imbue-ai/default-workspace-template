...
response. Do NOT call any tools, do NOT scan logs, do NOT run the caretaker
routine, do NOT look at the codebase, and do NOT add anything else:
...
Would you like me to check your apps for problems each night?

When I find something, what should I do -- just tidy up small things on my own, or take on bigger fixes too?
